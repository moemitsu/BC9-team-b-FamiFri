...
//     // transferQueryBulkResponses から requestTransferStatuses を抽出
//     const transferStatuses = response.data.transferQueryBulkResponses.flatMap((bulkResponse) => bulkResponse.requestTransferStatuses);
